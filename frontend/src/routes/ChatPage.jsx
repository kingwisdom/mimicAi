...
const ChatPage = () => {
    ...
    return (
        <>
                ...
                <div className="container">
                    ...
                    <div style={{ width: '100%' }}>
                        <div className="bg-white input-group input-group-icon input-mini">
                            <form style={{ width: '80%', margin: 15 }} onSubmit={handleSubmit} ref={formRef}>
                                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                                    <label htmlFor="file">
                                        <img src="https://cdn-icons-png.flaticon.com/512/385/385487.png" alt="" style={{ height: 20 }} /></label>
                                    {/* <Upload setImg={setImg} /> */}
                                    <input id="file" type="file" multiple={false} hidden />
                                    <textarea className="form-control" name="text" placeholder="Ask anything..." />
            ...
            {/* <NewPrompt /> */}
            <a href="/dashboard" className="btn btn-sm">Home</a>
        </>
    )
}
